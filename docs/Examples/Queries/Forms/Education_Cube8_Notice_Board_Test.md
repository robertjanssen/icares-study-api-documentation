...
# Education Cube8 Notice Board Test Form
...
```graphql
query getEducationCube8NoticeboardTestForm
{
  education_cube8_notice_board_test_form
  {
    test_type
    {
      type
...
A successful request returns the requested form information for the Education Cube8 Notice Board Test.
...
➡️ [Submit Cube8 Notice Board Test Answers](../../Mutations/Submit_Test/Education_Cube8_Notice_Board_Test.md)
